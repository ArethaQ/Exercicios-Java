...
public class TemaController {
	...
	public ResponseEntity<List<Tema>> getByDescricao(@PathVariable String descricao) {
		...
		/*
		 * na foto do controller está GetByTitle() e no doc da atividade está
		 * GetByDescricao(), achei mais coerente colocar o descricao(), mas acho que nao
		 * têm muita importancia.
		 */
	}
